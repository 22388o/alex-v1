...
(define-private (execute-proposal (proposal-id uint))
  (let (
    ...
    (try! (contract-call? .fixed-weight-pool set-fee-rate-x .token-wstx .token-t-alex u5000000000000000 u5000000000000000 new-fee-rate-x))
    (try! (contract-call? .fixed-weight-pool set-fee-rate-y .token-wstx .token-t-alex u5000000000000000 u5000000000000000 new-fee-rate-y))
